    ...
    renderOverlay() {
        ...
        overlay.innerHTML = `
            <div class="tutorial-modal">
                <button class="tutorial-close-absolute" onclick="TutorialSlideshow.close()">&times;</button>
                ...
                <div class="tutorial-content">
                    ...
                    <div class="tutorial-nav">
                        ...
                        <div class="tutorial-btn-group">
                            <button class="tutorial-btn" id="tutorialBackBtn" onclick="TutorialSlideshow.prev()">Back</button>
                            <button class="tutorial-btn primary" id="tutorialNextBtn" onclick="TutorialSlideshow.next()">Next</button>
                        </div>
                    </div>
                </div>
            </div>
